...
async function extracao(site){
    ...
    let cp = $(`body > table > tbody > tr:nth-child(4) > td > table:nth-child(4) > tbody > tr:nth-child(${i}) > td:nth-child(10)`).text().trim();
    ...
    //console.log([distribuidora,codigo,titular,classe,subgrupo,modalidade,credito,municipio,uf,cp,data,fonte,potencia,modulo,inversores,arranjo]);
